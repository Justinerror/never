...
public class OpenGaussCreateTableSqlBuilder {
    ...
    public OpenGaussCreateTableSqlBuilder(CatalogTable catalogTable, boolean createIndex) {
    ...
    private String buildColumnSql(Column column) {
        ...
        String columnType =
                StringUtils.equalsIgnoreCase(DatabaseIdentifier.OPENGAUSS, sourceCatalogName)
    ...
    private String buildColumnType(Column column) {
        return OpenGaussTypeConverter.INSTANCE.reconvert(column).getColumnType();
    }
