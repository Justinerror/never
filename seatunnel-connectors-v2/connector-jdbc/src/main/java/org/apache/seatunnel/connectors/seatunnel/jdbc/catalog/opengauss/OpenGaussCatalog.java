...
import org.apache.seatunnel.connectors.seatunnel.jdbc.internal.dialect.opengauss.OpenGaussTypeConverter;
import org.apache.seatunnel.connectors.seatunnel.jdbc.internal.dialect.opengauss.OpenGaussTypeMapper;
...
@Slf4j
public class OpenGaussCatalog extends AbstractJdbcCatalog {
    ...
    protected Column buildColumn(ResultSet resultSet) throws SQLException {
        ...
        if (typeName.equals(OpenGaussTypeConverter.GS_NUMERIC) && columnLength < 1) {
        ...
        BasicTypeDefine typeDefine =
                BasicTypeDefine.builder()
                        ...
                        .build();
        return OpenGaussTypeConverter.INSTANCE.convert(typeDefine);
    }

    @Override
    protected void createTableInternal(TablePath tablePath, CatalogTable table, boolean createIndex)
            throws CatalogException {
        OpenGaussCreateTableSqlBuilder openGaussCreateTableSqlBuilder =
                new OpenGaussCreateTableSqlBuilder(table, createIndex);
        String dbUrl = getUrlFromDatabaseName(tablePath.getDatabaseName());
        try {
            String createTableSql = openGaussCreateTableSqlBuilder.build(tablePath);
            executeInternal(dbUrl, createTableSql);

            if (openGaussCreateTableSqlBuilder.isHaveConstraintKey) {
            ...
            if (CollectionUtils.isNotEmpty(openGaussCreateTableSqlBuilder.getCreateIndexSqls())) {
                for (String createIndexSql : openGaussCreateTableSqlBuilder.getCreateIndexSqls()) {
    ...
    protected String getCreateTableSql(
        ...
        OpenGaussCreateTableSqlBuilder openGaussCreateTableSqlBuilder =
                new OpenGaussCreateTableSqlBuilder(table, createIndex);
        return openGaussCreateTableSqlBuilder.build(tablePath);
    }
    ...
    public CatalogTable getTable(String sqlQuery) throws SQLException {
        ...
        return CatalogUtils.getCatalogTable(defaultConnection, sqlQuery, new OpenGaussTypeMapper());
    }
